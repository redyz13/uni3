...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = findViewById(R.id.rubrica);
    ...
    public void onPictureClick(View v) {
        ...
        Toast.makeText(getApplicationContext(), "Click su foto posizione n. " + position + ": " + contatto.getName(), Toast.LENGTH_SHORT).show();
    }
